...
int32_t Epoll::EpollCreate(int iSize)
{
    m_iSize = iSize;
...
int32_t Epoll::EpollAdd(int32_t iFd)
{
    if(iFd < 0)
    {
        return -1;
...
int32_t Epoll::EpollDel(int32_t iFd)
{
    if(iFd < 0)
    {
        return -1;
...
int32_t Epoll::EpollWait(int32_t iTimeout)
{
...
struct epoll_event* Epoll::GetEvent(int32_t iIndex)
{
